...
- `Requires:` RVC4 device running Luxonis OS 1.40 or newer; static frontend build; prompt encoder dependencies from [backend/requirements.txt](backend/requirements.txt)

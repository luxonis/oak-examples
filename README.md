...
> Check out the [`master` branch](https://github.com/luxonis/depthai-experiments/tree/master) for legacy content and examples built with the previous DepthAIv2 version.

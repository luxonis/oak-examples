...
- [../human-pose](../human-pose/): use this when you need human pose
- [../hand-pose](../hand-pose/): use this when you need hand pose and gesture logic
- [../../3D-detection/objectron](../../3D-detection/objectron/): use this when you need another detect-then-keypoint workflow with geometry flavor

# Spatial Detections 2

This is an enhanced version of the spatial detections example with improved visualization. It shows how to use DepthAI and OAK camera to detect objects with their depth information in real-time! The example by default uses [YOLOv6 Nano](https://models.luxonis.com/luxonis/yolov6-nano/face58c4-45ab-42a0-bafc-19f9fee8a034) object detection model but you can use other models as well by using `-m` or `--model` argument. It should work with any YOLO detection model.

## Visualization Improvements

This version features:
- **Simplified depth display**: Shows only the depth (z-coordinate) rounded to the nearest millimeter
- **Enhanced aesthetics**: Improved text formatting, positioning, and visual hierarchy
- **Better readability**: Separated object label/confidence from depth information with larger, more prominent depth text

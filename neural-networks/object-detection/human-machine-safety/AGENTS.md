...
This is the repository reference for distance-based safety checks between detected palms and selected dangerous objects. Use it when you need multi-model detection fused with metric depth and host-side alert logic.
...
- `Requires:` metric depth, palm detector, object detector, and calibration

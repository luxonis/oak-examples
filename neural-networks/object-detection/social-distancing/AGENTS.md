...
- You want a bird’s-eye view derived from metric depth.
...
- `Requires:` SCRFD person detector, metric depth, and calibration
...
- `Depth` owns depth-source selection and aligns metric depth back to the RGB stream.

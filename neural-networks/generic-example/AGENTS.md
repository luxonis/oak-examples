...
- [utils/arguments.py](utils/arguments.py): model source, FPS limit, media path, API key, and overlay options
...
- `Safe to change:` model source, FPS limit, media path, private API key handling, Visualizer topic names

...
- You want to compare CREStereo-derived metric depth against DepthAI `Depth` output.
...
- [utils/disparity_to_depth.py](utils/disparity_to_depth.py) converts CREStereo disparity to metric depth using calibration before visualization.
